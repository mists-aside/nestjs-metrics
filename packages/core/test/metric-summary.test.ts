...
describe('src/metric', function () {
  ...
  describe('Controller(Metric::SummaryMetric)', () => {
    ...
    describe('observe()', () => {
      it('SummaryMetricController.observeAllAdapters() should trigger observe() function on all summary adapters', () => {
      ...
      it('SummaryMetricController.observeByAdapter() should trigger observe() function on all `prometheus` summary adapters', () => {
      ...
      it('SummaryMetricController.observeByMetric() should trigger observe() function on all `summary` summary adapters', () => {
        controller.observeByMetric(metricName);
        expect(summaryPrometheus.observe).to.have.been.calledWith({delta: 1, tags: undefined});
        expect(summaryStatsd.observe).to.have.been.called;
      });

      it('SummaryMetricController.observeWithTags() should trigger observe() function using {tag: `summary`}', () => {
        controller.observeWithTags();
        expect(summaryPrometheus.observe).to.have.been.calledWith({delta: 2, tags: {tag: 'summary'}});
      });

      it('SummaryMetricController.observeWithDecorator() should trigger observe() function using a decorator', async () => {
    ...
    describe('startTimer()', () => {
      it('SummaryMetricController.startTimerAllAdapters() should trigger startTimer() function on all summary adapters', async () => {
      ...
      it('SummaryMetricController.startTimerByAdapter() should trigger startTimer() function on all `prometheus` summary adapters', async () => {
      ...
      it('SummaryMetricController.startTimerByMetric() should trigger startTimer() function on all `summary` summary adapters', async () => {
        await controller.startTimerByMetric(metricName);
        expect(summaryPrometheus.startTimer).to.have.been.calledWith({tags: undefined});
        expect(summaryStatsd.startTimer).to.have.been.called;
      });

      it('SummaryMetricController.startTimerWithTags() should trigger startTimer() function using {tag: `summary`}', async () => {
        await controller.startTimerWithTags();
        expect(summaryPrometheus.startTimer).to.have.been.calledWith({tags: {tag: 'summary'}});
      });

      it('SummaryMetricController.startTimerWithEndTags() should trigger startTimer() function using {tag: `summary`}', async () => {
        await controller.startTimerWithEndTags();
        expect(endTimer).to.have.been.calledWith({tags: {tag: 'summary'}});
      });

      it('SummaryMetricController.startTimerWithDecorator() should trigger startTimer() function using a decorator', async () => {
    ...
    describe('reset()', () => {
      it('SummaryMetricController.resetByAdapter() should trigger reset() function on all summary adapters', () => {
      ...
      it(`SummaryMetricController.resetByAdapter('prometheus') should trigger reset() function on all 'prometheus' summary adapters`, () => {
        controller.resetByAdapter('prometheus');
        expect(summaryPrometheus.reset).to.have.been.called;
        expect(summaryStatsd.reset).to.not.have.been.called;
      });

      it(`SummaryMetricController.resetByMetricName('${metricName}') should trigger reset() function on all summary adapters`, () => {
