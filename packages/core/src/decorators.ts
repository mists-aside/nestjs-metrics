 ...
 */
export function Increment(delta?: number, label?: string, tags?: Tags, adapter?: string): MethodDecorator {
 ...
 * @returns {MethodDecorator}
 */
export function IncrementAsGauge(delta?: number, label?: string, tags?: Tags, adapter?: string): MethodDecorator {
  return function(target: any, propertyKey: string | symbol, descriptor: PropertyDescriptor): PropertyDescriptor {
    return null;
  }
}
 ...
 * @returns {MethodDecorator}
 */
export function GaugeSetTo(value: number, label?: string, tags?: Tags, adapter?: string): MethodDecorator {
  return function(target: any, propertyKey: string | symbol, descriptor: PropertyDescriptor): PropertyDescriptor {
    return null;
  }
}
 ...
 * @returns {MethodDecorator}
 */
export function Duration(label?: string, tags?: Tags, adapter?: string): MethodDecorator {
  return function(target: any, propertyKey: string | symbol, descriptor: PropertyDescriptor): PropertyDescriptor {
    return null;
  }
}
 ...
 * @returns {MethodDecorator}
 */
export function DurationToHistogram(label?: string, tags?: Tags, adapter?: string): MethodDecorator {
  return function(target: any, propertyKey: string | symbol, descriptor: PropertyDescriptor): PropertyDescriptor {
    return null;
  }
}
 ...
 * @returns {MethodDecorator}
 */
export function DurationToSummary(label?: string, tags?: Tags, adapter?: string): MethodDecorator {
  return function(target: any, propertyKey: string | symbol, descriptor: PropertyDescriptor): PropertyDescriptor {
    return null;
  }
}
